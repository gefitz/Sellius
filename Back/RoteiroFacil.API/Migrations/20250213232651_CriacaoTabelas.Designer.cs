...
namespace RoteiroFacil.API.Migrations
{
    ...
    [Migration("20250213232651_CriacaoTabelas")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoteiroFacil.API.Models.InfoBancoModel", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RoteiroFacil.API.Models.UsuarioModel", b =>
                {
                    b.HasOne("RoteiroFacil.API.Models.InfoBancoModel", "InfoBanco")
                        .WithMany()
                        .HasForeignKey("InfoBancoid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("InfoBanco");
                });
